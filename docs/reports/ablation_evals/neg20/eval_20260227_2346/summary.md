...
- Generated: 2026-02-27 23:48:54
- Model: `/Users/quan/Documents/personal/Stanford application project/.claude/worktrees/focused-cannon/runs/ablation/neg20/weights/best.pt`
- Git commit: `c53930d`
...
|---|---:|---:|---:|---:|---:|---:|
| 0.25 | 0.7237 | 0.7237 | 0.7237 | 55 | 21 | 21 |
| 0.35 | 0.7778 | 0.6447 | 0.7050 | 49 | 14 | 27 |
| 0.45 | 0.8148 | 0.5789 | 0.6769 | 44 | 10 | 32 |
| 0.55 | 0.8372 | 0.4737 | 0.6050 | 36 | 7 | 40 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `2907` | 4 | 0.989 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | 0 |
| `2909` | 3 | 0.997 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | 0 |
| `2911` | 3 | 0.968 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | 0 |
| **Mean** | **3.333** | **0.985** | **0.00** | **0.00** | **0.00** | **0.00** | **1.00** | **0.000** |

## Delta vs Baseline

| Metric | Baseline | Current | Delta | Delta % |
|---|---:|---:|---:|---:|
| F1 | 0.7671 | 0.7050 | -0.0621 | -8.09% |
| Gates detected | 3.6667 | 3.3333 | -0.3333 | -9.09% |
...
Reasons:
- F1 decreased (0.7050 < baseline 0.7671).
